...
void Ali_DarkMatter_ESD_analysis::UserCreateOutputObjects()
{
    ...
    vec_invmass_L_r.resize(140*2);
    vec_invmass_K0_r.resize(140);
    ...
    for(int i=0;i<70;i++)
    {
        ...
        n ="invmassAntiL_r_";
        n+=to_string(i);
        vec_invmass_L_r[i+140] = new TH1D(n.Data(),n.Data(),100,1.1,1.13);
        fListOfHistos->Add(vec_invmass_L_r[i+140]);
    }

    for(int i=0;i<70;i++)
    {
        TString n ="invmassLprim_r_";
        n+=to_string(i);
        ...
        n+=to_string(i);
        vec_invmass_L_r[i+140+70] = new TH1D(n.Data(),n.Data(),100,1.1,1.13);
        fListOfHistos->Add(vec_invmass_L_r[i+140+70]);
    }
       ...
       */
        ...
        if(fabs(sigma_p_N) < 2.5 && fabs(sigma_pi_P) < 2.5)
        {
            ...
            for(int j=0;j<70;j++)
            {
                ...
                {
                    if(radius>j) vec_invmass_L_r[j+140]->Fill(invariantmass);
                    if(radius>j && dist<0.5) vec_invmass_L_r[j+140+70]->Fill(invariantmass);
                }
