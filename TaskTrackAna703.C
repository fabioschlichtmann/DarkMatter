...
// analysis source to be compiled at runtime (if any)
   gROOT->ProcessLine(".L Ali_DarkMatter_ESD_analysis.cxx+g");

// read the analysis manager from file
   AliAnalysisManager *mgr = AliAnalysisAlien::LoadAnalysisManager("TaskTrackAna703.root");
   if (!mgr) return;
   mgr->PrintStatus();
